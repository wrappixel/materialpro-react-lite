...
const ActivityTimeline = () => {
  ...
  return (
    <>
      <DashboardCard title="Profile Activitiy" subtitle="Ample Admin Vs Pixel Admin">
          ...
          <TabContext value={value}>
              ...
              >
                <TimelineItem>
                  <TimelineSeparator>
                    ...
                    >
                      <Avatar src={user4} alt="user" sx={{ width: 56, height: 56 }} />
                    </TimelineDot>
                    <TimelineConnector />
                  </TimelineSeparator>
                  <TimelineContent>
                ...
                <TimelineItem>
                  <TimelineSeparator>
                    ...
                    >
                      <Avatar src={user5} alt="user" sx={{ width: 56, height: 56 }} />
                    </TimelineDot>
                    <TimelineConnector />
                  </TimelineSeparator>
                  <TimelineContent>
                ...
                <TimelineItem>
                  <TimelineSeparator>
                    ...
                    >
                      <Avatar src={user6} alt="user" sx={{ width: 56, height: 56 }} />
                    </TimelineDot>
                    <TimelineConnector />
                  </TimelineSeparator>
                  <TimelineContent>
                    ...
                    <Grid container spacing={2}>
                      ...
                      >
                        <Box
                          ...
                          padding="20px 30px"
                        >
                          <img src={zipIcon} width={38} alt="icon" height={40} />
                          <Box>
                      ...
                      >
                        <Box
                          ...
                          padding="20px 30px"
                        >
                          <img src={figmaIcon} width={38} alt="icon" height={40} />
                          <Box>
                            <Typography variant="h6" mb={1}>
                              Payments.zip
                            </Typography>
                    ...
                    <Typography variant="subtitle1" color="textSecondary" fontSize="15px" mt={1}>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio.
                      Praesent libero.
                    </Typography>
                  </TimelineContent>
            ...
            >
              ...
              <Stack spacing={3} mt={3}>
                ...
                <Box>
                  ...
                  <LinearProgress color="error" variant="determinate" value={45} />
                </Box>
                <Box>
                  <Stack direction="row" justifyContent="space-between" spacing={1}>
                    <Typography variant="subtitle1" mb={1}>
            ...
            >
              <form>
                ...
                <CustomFormLabel htmlFor="text-password">Password</CustomFormLabel>
                <CustomTextField id="text-password" type="password" variant="outlined" fullWidth />
